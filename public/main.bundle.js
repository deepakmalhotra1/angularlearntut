...
var appRoutes = [
    ...
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_10__profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] },
];
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Welcome to the mean auth app</h1>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>&nbsp;&nbsp;&nbsp;&nbsp;\n    <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n\n  <div class=\"col-sm-4\">\n    <h1>Express App</h1>\n    <p>This is an express app generated by using node express generator</p>\n  </div>\n  <div class=\"col-sm-4\">\n    <h1>Angular cli</h1>\n    <p>This is an express app generated by using @angular/cli generator</p>\n  </div>\n  <div class=\"col-sm-4\">\n    <h1>Jwt tokens</h1>\n    <p>This use passport-jwt for login auth</p>\n  </div>\n</div>\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(http, authService, flashMessages, router) {
        this.http = http;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessages.show('Successfully login ', { cssClass: 'alert-success', timeout: 1000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMessages.show('Wrong credentials please try again ', { cssClass: 'alert-danger', timeout: 1000 });
            }
        });
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessages.show('You are logged out', { cssClass: 'alert-success', timeout: 1000 });
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessages.show('Some error occurred', { cssClass: 'alert-danger', timeout: 3000 });
